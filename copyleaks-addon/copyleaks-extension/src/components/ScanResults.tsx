import { IScanResult } from "src/data/types";
import { Flex, Progress, ProgressProps, Empty, Typography, Skeleton } from "antd";
                        ...
                        <h2 style={{ fontWeight: "normal", fontSize: 18 }}>Scan Id :{scanId}</h2>
                        {
                            scanResult?.results.internet.length !== 0 ? scanResult?.results.internet.map((item: any) => {
                                ...
                                <Flex align="center" justify="center">
                                    <NotFound description="Copyleaks Internet scan results are not found." />
                                </Flex>
                        }
                    </>
                    :
                    <NotFound description={errorMsg} />
            }
        </Flex>
    )
}
